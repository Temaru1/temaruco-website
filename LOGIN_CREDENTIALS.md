...
1. Go to: `https://temaru-web-clone.preview.emergentagent.com/admin/login`
2. Enter email and password
3. Click "Sign In"

### Method 2: Main Site
1. Go to: `https://temaru-web-clone.preview.emergentagent.com`
...
**Login URL**: https://temaru-web-clone.preview.emergentagent.com/admin/login
