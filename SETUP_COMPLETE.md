...
PAYMENT_MOCK=true
EMAIL_MOCK=true
FRONTEND_URL=https://fashionprint-app.preview.emergentagent.com
CORS_ORIGINS=*
```
...
```
REACT_APP_BACKEND_URL=https://fashionprint-app.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
**Backend URL**: https://fashionprint-app.preview.emergentagent.com/api
**Frontend URL**: https://fashionprint-app.preview.emergentagent.com
**Preview URL**: https://fashionprint-app.preview.emergentagent.com
...
**Test Frontend**:
Open browser to: https://fashionprint-app.preview.emergentagent.com

**Test Admin Login**:
1. Navigate to: https://fashionprint-app.preview.emergentagent.com/admin/login
