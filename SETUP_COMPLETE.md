...
PAYMENT_MOCK=true
EMAIL_MOCK=true
FRONTEND_URL=https://bulk-sizing-orders.preview.emergentagent.com
CORS_ORIGINS=*
```
...
```
REACT_APP_BACKEND_URL=https://bulk-sizing-orders.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
**Backend URL**: https://bulk-sizing-orders.preview.emergentagent.com/api
**Frontend URL**: https://bulk-sizing-orders.preview.emergentagent.com
**Preview URL**: https://bulk-sizing-orders.preview.emergentagent.com
...
**Test Frontend**:
Open browser to: https://bulk-sizing-orders.preview.emergentagent.com

**Test Admin Login**:
1. Navigate to: https://bulk-sizing-orders.preview.emergentagent.com/admin/login
