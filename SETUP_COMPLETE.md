...
PAYMENT_MOCK=true
EMAIL_MOCK=true
FRONTEND_URL=https://fabric-moq-system.preview.emergentagent.com
CORS_ORIGINS=*
```
...
```
REACT_APP_BACKEND_URL=https://fabric-moq-system.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
**Backend URL**: https://fabric-moq-system.preview.emergentagent.com/api
**Frontend URL**: https://fabric-moq-system.preview.emergentagent.com
**Preview URL**: https://fabric-moq-system.preview.emergentagent.com
...
**Test Frontend**:
Open browser to: https://fabric-moq-system.preview.emergentagent.com

**Test Admin Login**:
1. Navigate to: https://fabric-moq-system.preview.emergentagent.com/admin/login
