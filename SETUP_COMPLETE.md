...
PAYMENT_MOCK=true
EMAIL_MOCK=true
FRONTEND_URL=https://temaru-web-clone.preview.emergentagent.com
CORS_ORIGINS=*
```
...
```
REACT_APP_BACKEND_URL=https://temaru-web-clone.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
**Backend URL**: https://temaru-web-clone.preview.emergentagent.com/api
**Frontend URL**: https://temaru-web-clone.preview.emergentagent.com
**Preview URL**: https://temaru-web-clone.preview.emergentagent.com
...
**Test Frontend**:
Open browser to: https://temaru-web-clone.preview.emergentagent.com

**Test Admin Login**:
1. Navigate to: https://temaru-web-clone.preview.emergentagent.com/admin/login
