...
PAYMENT_MOCK=true
EMAIL_MOCK=true
FRONTEND_URL=https://guest-tracker-40.preview.emergentagent.com
CORS_ORIGINS=*
```
...
```
REACT_APP_BACKEND_URL=https://guest-tracker-40.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
**Backend URL**: https://guest-tracker-40.preview.emergentagent.com/api
**Frontend URL**: https://guest-tracker-40.preview.emergentagent.com
**Preview URL**: https://guest-tracker-40.preview.emergentagent.com
...
**Test Frontend**:
Open browser to: https://guest-tracker-40.preview.emergentagent.com

**Test Admin Login**:
1. Navigate to: https://guest-tracker-40.preview.emergentagent.com/admin/login
