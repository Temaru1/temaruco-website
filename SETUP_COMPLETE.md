...
PAYMENT_MOCK=true
EMAIL_MOCK=true
FRONTEND_URL=https://serverpy-reorg.preview.emergentagent.com
CORS_ORIGINS=*
```
...
```
REACT_APP_BACKEND_URL=https://serverpy-reorg.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
**Backend URL**: https://serverpy-reorg.preview.emergentagent.com/api
**Frontend URL**: https://serverpy-reorg.preview.emergentagent.com
**Preview URL**: https://serverpy-reorg.preview.emergentagent.com
...
**Test Frontend**:
Open browser to: https://serverpy-reorg.preview.emergentagent.com

**Test Admin Login**:
1. Navigate to: https://serverpy-reorg.preview.emergentagent.com/admin/login
