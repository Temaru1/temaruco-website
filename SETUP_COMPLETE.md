...
PAYMENT_MOCK=true
EMAIL_MOCK=true
FRONTEND_URL=https://file-supplier-mgmt.preview.emergentagent.com
CORS_ORIGINS=*
```
...
```
REACT_APP_BACKEND_URL=https://file-supplier-mgmt.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
**Backend URL**: https://file-supplier-mgmt.preview.emergentagent.com/api
**Frontend URL**: https://file-supplier-mgmt.preview.emergentagent.com
**Preview URL**: https://file-supplier-mgmt.preview.emergentagent.com
...
**Test Frontend**:
Open browser to: https://file-supplier-mgmt.preview.emergentagent.com

**Test Admin Login**:
1. Navigate to: https://file-supplier-mgmt.preview.emergentagent.com/admin/login
