...
1. **Open Admin Login Page**:
   ```
   https://bulk-sizing-orders.preview.emergentagent.com/admin/login
   ```
...
1. **Backend API**: https://bulk-sizing-orders.preview.emergentagent.com/api/bank-details
   - Should show bank details

2. **Test Connection**: https://bulk-sizing-orders.preview.emergentagent.com/test-connection.html
   - Should show green checkmarks

3. **Admin Login**: https://bulk-sizing-orders.preview.emergentagent.com/admin/login
