...
1. **Open Admin Login Page**:
   ```
   https://file-supplier-mgmt.preview.emergentagent.com/admin/login
   ```
...
1. **Backend API**: https://file-supplier-mgmt.preview.emergentagent.com/api/bank-details
   - Should show bank details

2. **Test Connection**: https://file-supplier-mgmt.preview.emergentagent.com/test-connection.html
   - Should show green checkmarks

3. **Admin Login**: https://file-supplier-mgmt.preview.emergentagent.com/admin/login
