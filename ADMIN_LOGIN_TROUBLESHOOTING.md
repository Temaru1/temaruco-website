...
1. **Open Admin Login Page**:
   ```
   https://apparel-manager-31.preview.emergentagent.com/admin/login
   ```
...
1. **Backend API**: https://apparel-manager-31.preview.emergentagent.com/api/bank-details
   - Should show bank details

2. **Test Connection**: https://apparel-manager-31.preview.emergentagent.com/test-connection.html
   - Should show green checkmarks

3. **Admin Login**: https://apparel-manager-31.preview.emergentagent.com/admin/login
