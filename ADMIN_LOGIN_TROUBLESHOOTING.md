...
1. **Open Admin Login Page**:
   ```
   https://fashion-hub-1023.preview.emergentagent.com/admin/login
   ```
...
1. **Backend API**: https://fashion-hub-1023.preview.emergentagent.com/api/bank-details
   - Should show bank details

2. **Test Connection**: https://fashion-hub-1023.preview.emergentagent.com/test-connection.html
   - Should show green checkmarks

3. **Admin Login**: https://fashion-hub-1023.preview.emergentagent.com/admin/login
