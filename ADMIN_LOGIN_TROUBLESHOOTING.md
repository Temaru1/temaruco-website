...
1. **Open Admin Login Page**:
   ```
   https://fashionprint-app.preview.emergentagent.com/admin/login
   ```
...
1. **Backend API**: https://fashionprint-app.preview.emergentagent.com/api/bank-details
   - Should show bank details

2. **Test Connection**: https://fashionprint-app.preview.emergentagent.com/test-connection.html
   - Should show green checkmarks

3. **Admin Login**: https://fashionprint-app.preview.emergentagent.com/admin/login
