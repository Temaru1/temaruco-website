      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/design-services" className="nav-link text-sm font-medium" data-testid="nav-design-services">
              Design Services
            </Link>
        ...
        {isOpen && (
          <div className="md:hidden pb-4 space-y-2 border-t border-zinc-200 pt-4" data-testid="mobile-menu">
            ...
            <Link to="/design-services" className="block py-2 px-4 hover:bg-zinc-50 rounded-lg text-sm font-medium text-zinc-700" onClick={() => setIsOpen(false)}>
              Design Services
            </Link>
